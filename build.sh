...
echo "CFLAGS = -std=c++14 -faligned-new -DNDEBUG -D__STDC_FORMAT_MACROS -Wall -O3 -Wno-sign-compare -Wno-unused-result -march=native -fomit-frame-pointer -flto" >> build_config.mk
